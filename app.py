...
provinces = ["All Regions"] + sorted(list(districts_df['province'].unique()))
...
district_names = sorted(filtered_districts['district'].tolist())
selected_district_name = st.sidebar.selectbox("Select Target District / Station", district_names)

# Match selected district ID
selected_district_row = districts_df[districts_df['district'] == selected_district_name].iloc[0]
